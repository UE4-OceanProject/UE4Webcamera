...
class IAnyCam : public IModuleInterface
{
public:
	...
	*/
	static inline IAnyCam& Get()
	{
		return FModuleManager::LoadModuleChecked<IAnyCam>("AnyCam");
	}
	...
	*/
	...
	{
		return FModuleManager::Get().IsModuleLoaded("AnyCam");
	}
